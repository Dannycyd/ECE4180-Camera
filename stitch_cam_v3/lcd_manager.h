...
#include "config.h"
#include "hardware/DEV_Config.h"
#include "hardware/LCD_Driver.h"
#include "hardware/GUI_Paint.h"

// Undefine color macros from GUI_Paint to prevent conflicts with LEDColor enum
#undef LCDColor::RED
#undef LCDColor::GREEN
#undef LCDColor::BLUE
#undef LCDColor::YELLOW
#undef LCDColor::CYAN
#undef MAGENTA
#undef LCDColor::WHITE
#undef LCDColor::BLACK

// Redefine as const values for LCD use (RGB565 format)
namespace LCDColor {
  constexpr uint16_t LCDColor::BLACK   = 0x0000;
  constexpr uint16_t LCDColor::WHITE   = 0xFFFF;
  constexpr uint16_t LCDColor::RED     = 0xF800;
  constexpr uint16_t LCDColor::GREEN   = 0x07E0;
  constexpr uint16_t LCDColor::BLUE    = 0x001F;
  constexpr uint16_t LCDColor::YELLOW  = 0xFFE0;
  constexpr uint16_t LCDColor::CYAN    = 0x7FFF;
